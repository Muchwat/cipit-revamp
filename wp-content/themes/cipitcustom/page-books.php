...
<div class="breadcrumbs">
    <div>
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>">Home</a> / <span>Publications</span> /
...
<main class="container mx-auto px-4 py-8">
    ...
    // Featured Book Query (fetch up to 3 sticky posts)
    ...
    // Capture all featured post IDs for exclusion
    $exclude_post_ids = [];
    ...
    // Main Books Query - exclude featured posts
